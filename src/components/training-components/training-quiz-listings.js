...
const QuizListings = ({data, returnInfo, route, toggleDynamicRoute, readyToRedirect}) => {
    return (
        <>
            ...
            {data.forms ? <SubListings data={data.forms} listingType="forms" returnInfo={returnInfo}/> : null}
            {data.reviews ? <SubListings data={data.reviews} listingType="reviews" returnInfo={returnInfo}/> : null}
            ...
            {data.examResults ? <SubListings data={data.examResults} listingType="exam results" returnInfo={returnInfo}/> : null}
        </>
    )
}
